				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="navbarSupportedContent">
				      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				        ...
				        <li class="nav-item">
				          <a style="margin-left:10px; border:light" class="btn btn-outline-light" href="Productos.jsp">Productos</a>
				        </li>
				        <li class="nav-item">
  ...
  <thead>
    <tr>
      <th colspan="5" scope="col"><center>
        <h5>Formulario de Productos</h5></th>
    </tr>
  </thead>
  <tbody>
    <tr>
     <th scope="row">Nombre del Archivo</th>
      <th scope="row"><input name="NARCHIVO" type="text" id="NARCHIVO" placeholder = " ARCHIEVE NAME"  value="<%=d%>" /></th>
      <th scope="row"><input type="submit" name="btnact" value="Examinar" class="btn btn-success" /> 
       </th>

      </tr>
    <th colspan="5" scope="row"><center><input type="submit" name="btneli" value="Cargar" class="btn btn-danger" /></tr> 
    <tr>
      <th scope="row">&nbsp;</th>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
