				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="navbarSupportedContent">
				      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				        ...
				        <li class="nav-item">
				          <a style="margin-left:10px; border:light" class="btn btn-outline-light" href="Reportes.jsp">Reportes</a>
				        </li>
				        </ul>
				    </div>
				  </div>
  ...
  <thead>
    <tr>
      <th colspan="7" scope="col"><center>
        <h5>Formulario de Reportes</h5></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th colspan="7" scope="row"> <center> <input type="submit" name="btnins" value="Listado de Usuarios" class="btn btn-primary" /> 
    </tr>
     <tr>
      <th colspan="7" scope="row"> <center> <input type="submit" name="btnins" value="Listado de Clientes" class="btn btn-success" /> 
    </tr> 
    <tr>
      <th colspan="7" scope="row"> <center> <input type="submit" name="btnins" value="Ventas por Cliente" class="btn btn-danger" /> 
    </tr>
    <tr>
      <th scope="row">&nbsp;</th>
      <td>&nbsp;</td>
